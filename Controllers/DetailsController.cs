...
namespace TrailService.Controllers
{
    ...
    public class DetailsController : ControllerBase
    {
        ...
        public DetailsController(Comp2001DlivermoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Detail>> PostDetail(Detail detail)
        {
          if (_context.Details == null)
          {
              return Problem("Entity set 'Comp2001DlivermoreContext.Details'  is null.");
          }
            _context.Details.Add(detail);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetDetail", new { id = detail.DetailsId }, detail);
        }
